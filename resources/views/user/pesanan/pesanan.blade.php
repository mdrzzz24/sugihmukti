...
<div class=" py-5 bg-ligt">
  ...
  <form class="mx-auto" style="max-width: 600px;">
    ...
    <div class="mb-3">
      <label for="inputPackage" class="form-label">Paket Wisata</label>
      <select id="inputPackage" class="form-select" required>
        <option selected disabled value="">Pilih paket...</option>
        <option>Heal The Soul Sugihmukti</option>
        <option>Explore Sugihmukti</option>
        <option>Bird Watch</option>
        <option>Let's Sippin Coffe in Sugihmukti</option>
        <option>Family Trip To Sugihmukti</option>
      </select>
    </div>
    <div class="mb-3">
      <label for="inputDate" class="form-label">Tanggal Kunjungan</label>
      <input type="date" class="form-control" id="inputDate" required>
    </div>
    <div class="mb-3">
      <label for="inputGuests" class="form-label">Jumlah Peserta</label>
      <input type="number" class="form-control" id="inputGuests" min="1" required>
    </div>
    <div class="mb-3">
    ...
    <div class="text-center">
      <button type="submit" class="btn fw-bold py-2 px-6 rounded-pill w-50" style="background-color: #80AF81; border-color: #80AF81; color: white;">Pesan</button>
    </div>
  </form>
</div>
